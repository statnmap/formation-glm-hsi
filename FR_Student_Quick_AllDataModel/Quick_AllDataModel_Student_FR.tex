...
{\centering \includegraphics[width=0.9\linewidth]{Quick_AllDataModel_Student_FR_files/figure-latex/RFigDataGG-1} 
...
\item
  ...
  \begin{itemize}
  \item
    \exo{Quelles covariables pourraient avoir une influence ?}
  \end{itemize}
\end{itemize}
...
{\centering \includegraphics[width=0.9\linewidth]{Quick_AllDataModel_Student_FR_files/figure-latex/RFigDistrib-1} 
...
{\centering \includegraphics{Quick_AllDataModel_Student_FR_files/figure-latex/RFigResidualsDiag-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{Quick_AllDataModel_Student_FR_files/figure-latex/RFigGLMPredict-1} 
