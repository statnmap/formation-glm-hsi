...
{\centering \includegraphics[width=0.9\linewidth]{FR_Classic_AllDataModel_Student_files/figure-latex/RFigDataGG-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{FR_Classic_AllDataModel_Student_files/figure-latex/RFigDistrib-1} 
...
{\centering \includegraphics{FR_Classic_AllDataModel_Student_files/figure-latex/RFigResidualsDiag-1} 
...
{\centering \includegraphics{FR_Classic_AllDataModel_Student_files/figure-latex/RFigGLMResults-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{FR_Classic_AllDataModel_Student_files/figure-latex/RFigGLMPredict-1} 
