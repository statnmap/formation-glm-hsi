...
{\centering \includegraphics[width=0.9\linewidth]{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigDataGG-1} 
...
\item
  ...
  \tightlist
  \item
    \exo{Quelles covariables pourraient avoir une influence ?}(Fig. \ref{fig:RFigHistGG})
  \end{itemize}
\end{itemize}
...
{\centering \includegraphics[width=1\linewidth]{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigHistGG-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigDistrib-1} 
...
{\centering \includegraphics[width=1\linewidth]{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigTwoFact-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigExInteractions-1} 
...
{\centering \includegraphics{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigResidualsExemple-1} 
...
{\centering \includegraphics{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigResidualsDiag-1} 
...
{\centering \includegraphics{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigAICExample-1} 
...
\tightlist
\item
  \exo{Que pouvez-vous dire sur le diagnostic complet de votre modèle ?} (Fig. \ref{fig:RFigGLMResults})
\end{itemize}
...
{\centering \includegraphics{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigGLMResults-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{FR_Classic_AllDataModel_Teacher_files/figure-latex/RFigGLMPredict-1} 
